...
const WalletScreen = () => {
    ...
    const handleAddFunds = async () => {
        ...
        try {
            ...
            Alert.alert(
                t('common.error'),
                error.response?.data?.message || t('wallet.processFailed'),
            );
        } finally {
            setAdding(false);
        }
                    ...
                    <View className="pb-28">
                        {wallet.transactions.map((tx, index) => (
                            ...
                            >
                                ...
                                {/* Amount */}
                                <Text
                                    className={`text-lg font-bold ${tx.type === 'credit' ? 'text-emerald-600' : 'text-red-500'}`}
                                >
                                    {tx.type === 'credit' ? '+' : '-'}
            ...
            >
                <View className="flex-1 bg-black/50 justify-end">
                    ...
                    >
                        ...
                        {/* Payment Methods */}
                        <View className="mb-6">
                            <Text className="text-xs font-bold text-slate-500 uppercase mb-3">
                        ...
                        <View className="flex-row gap-3">
                            ...
                            <TouchableOpacity
                                ...
                                className={`flex-1 py-4 rounded-xl items-center ${
                                    adding || !addAmount ? 'bg-slate-300' : 'bg-emerald-500'
                                }`}
                            >
                                {adding ? (
