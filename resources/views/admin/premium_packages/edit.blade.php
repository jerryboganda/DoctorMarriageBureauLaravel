                ...
                <div class="card-body">
                    <form action="{{ route('packages.update', $package->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="number" name="contact" value="{{ $package->contact }}" id="contact" value="{{ $package->contact }}" class="form-control" placeholder="{{translate('Eg. 10')}}" required>
                                @error('contact')
                                    <small class="form-text text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row">
                            <label class="col-md-3 col-form-label" for="profile_viewers_view">{{translate('Profile Viewers View')}}</label>
                            <div class="col-md-9">
                                <input type="number" name="profile_viewers_view" value="{{ $package->profile_viewers_view }}" id="profile_viewers_view" class="form-control" placeholder="{{translate('Eg. 10')}}" required>
                                @error('profile_viewers_view')
                                    <small class="form-text text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                        </div>
