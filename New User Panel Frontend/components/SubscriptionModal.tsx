        ...
        >
            ...
            >
                <div className="flex flex-col items-center justify-center pt-8 pb-4 px-6 relative bg-white shrink-0">
                    <button
                        onClick={onClose}
                        className="absolute right-6 top-6 p-2 bg-slate-100 hover:bg-slate-200 rounded-full text-slate-500 transition-colors"
                    >
                        <X size={20} />
                    </button>
                    ...
                    {activeTab === 'plans' ? (
                        <>
                            ...
                            {!loading && !error && plans.length === 0 && (
                                <div className="text-center py-12 text-slate-500">
                                    {t('billing.subscription.noPlans')}
                                </div>
                            )}
                        ...
                        <div className="max-w-3xl mx-auto space-y-6">
                            ...
                            {!loadingAddons && !addonError && addonItems.length === 0 && (
                                <div className="text-center py-12 text-slate-500">
                                    {t('billing.subscription.noAddons')}
                                </div>
                            )}
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    {addonItems.map((addon) => (
                                        <motion.div
                                            ...
                                            key={addon.id}
                                            className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm flex flex-col gap-4 group hover:border-primary/50 transition-all"
                                        >
                                            <div className="flex items-start gap-4">
                                                ...
                                                <div className="flex-1">
                                                    ...
                                                    <p className="text-xs text-slate-500 mt-1">
                                                        {addon.description ||
                                                            t('billing.subscription.addonUpgrade')}
                                                    </p>
                                                </div>
                                            </div>
