...
export const MOCK_PROFILES: ProfileMatch[] = [
    ...
    },
    {
        ...
        matchPercentage: 91,
        avatarUrl:
            'https://images.unsplash.com/photo-1614608682850-e0d6ed316d47?auto=format&fit=crop&q=80&w=400&h=400',
        isVerified: true,
        isAgentPick: true,
    },
];
...
export const RECENT_ACTIVITY: ActivityItem[] = [
    { id: '1', type: 'view', user: 'Dr. Zainab', time: '12 mins ago' },
    {
        ...
        type: 'message',
        user: 'Dr. Sana Mir',
        message: '"As-salamu alaykum Dr. Ahmed, I saw..."',
        time: '1 hour ago',
        isNew: true,
    },
...
export const MOCK_CHATS: Chat[] = [
    {
        ...
        lastMessage: {
            id: 'm1',
            senderId: '1',
            text: 'InshaAllah, Saturday works for me.',
            type: 'text',
            timestamp: '10:42 AM',
            status: 'read',
        },
    ...
    },
    {
        ...
        lastMessage: {
            id: 'm4',
            senderId: '4',
            text: 'As-salamu alaykum, interesting profile!',
            type: 'text',
