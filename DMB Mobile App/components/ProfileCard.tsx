...
import { MapPinIcon, GraduationCapIcon, StarIcon, CheckCircleIcon, StethoscopeIcon } from './Icons';
...
export default function ProfileCard({
    ...
    return (
        <TouchableOpacity activeOpacity={0.92} onPress={onPress} className="items-center">
            <View
                ...
                <View className="h-[78%] relative">
                    ...
                    >
                        ...
                        <View className="mt-2 flex-row items-center gap-2">
                            ...
                            {hospital && (
                                <Text
                                    className="text-white/80 text-sm font-medium truncate shield-check"
                                    numberOfLines={1}
                                >
                                    @{hospital}
                                </Text>
                    ...
                    <View className="absolute top-5 right-5 bg-white/90 backdrop-blur-xl px-3 pl-2.5 py-1.5 rounded-full flex-row items-center gap-1.5 shadow-sm border border-white/50">
                        ...
                        <Text className="text-slate-900 font-extrabold text-xs">
                            {t('profileCard.match', { score: matchScore })}
                        </Text>
                    </View>
                    ...
                    <View className="flex-row items-start pt-1">
                        ...
                        <View className="flex-1 flex-row gap-3 pr-2 border-r border-slate-100">
                            ...
                            <View className="flex-1">
                                ...
                                <Text
                                    className="text-slate-700 font-semibold text-sm leading-5"
                                    numberOfLines={2}
                                >
                                    {location}
                                </Text>
