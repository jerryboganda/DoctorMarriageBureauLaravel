...
Route::get('/health', [RuntimeController::class, 'health']);
...
Route::group(['namespace' => 'Api', 'middleware' => ['app_language']], function () {
    ...
    Route::get('/trusted-contact/verify/{token}', [RuntimeController::class, 'verifyTrustedContact']);
    ...
    Route::get('google-recaptcha', [RuntimeController::class, 'googleRecaptcha']);
    ...
    Route::group(['middleware' => ['auth:sanctum', 'api_email_verified', 'api_member', 'api_require_password_change']], function () {
        ...
        Route::group(['prefix' => 'member'], function () {
            ...
            Route::post('/heartbeat', [RuntimeController::class, 'heartbeat']);
            Route::post('/user-online-status', [RuntimeController::class, 'userOnlineStatus']);
    ...
    Route::group(['middleware' => ['auth:sanctum', 'api_email_verified', 'api_member', 'api_require_password_change']], function () {
        ...
        // Dashboard Stats
        Route::get('/dashboard/stats', [DashboardWidgetController::class, 'stats']);

        // Incoming Interest
        Route::get('/dashboard/incoming-interest', [DashboardWidgetController::class, 'incomingInterest']);

        // Message Preview
        Route::get('/dashboard/message-preview', [DashboardWidgetController::class, 'messagePreview']);

        // Mutual Match
        Route::get('/dashboard/mutual-match', [DashboardWidgetController::class, 'mutualMatch']);

        // Recent Visitors
        Route::get('/dashboard/recent-visitors', [DashboardWidgetController::class, 'recentVisitors']);

        // Success Stories
        Route::get('/dashboard/success-stories', [DashboardWidgetController::class, 'successStories']);

        // Today Matches
        Route::get('/dashboard/today-matches', [DashboardWidgetController::class, 'todayMatches']);

        // Interest Actions
        Route::post('/interest/accept', [DashboardWidgetController::class, 'acceptInterest']);
        Route::post('/interest/decline', [DashboardWidgetController::class, 'declineInterest']);
