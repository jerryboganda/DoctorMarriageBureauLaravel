...
import Svg, { Circle, Path, Line, Ellipse, G, Defs, RadialGradient, Stop } from 'react-native-svg';
...
const FEATURES = [
  { icon: ShieldIcon, title: 'Verified Doctors', subtitle: 'Only licensed medical professionals' },
...
function AnimatedLogo({ size, phase }: { size: number; phase: 'splash' | 'welcome' }) {
  ...
  useEffect(() => {
    ...
    raysRotation.value = withDelay(1500, withRepeat(
      withTiming(360, { duration: 40000, easing: Easing.linear }), -1, false
    ));
  ...
  return (
    <View style={{ width: s, height: s, alignItems: 'center', justifyContent: 'center' }}>
      ...
      <Animated.View style={[StyleSheet.absoluteFill, raysStyle, { alignItems: 'center', justifyContent: 'center' }]}>
      ...
      <Animated.View style={[StyleSheet.absoluteFill, ringStyle, { alignItems: 'center', justifyContent: 'center' }]}>
        <Svg width={s} height={s} viewBox={`0 0 ${s} ${s}`}>
          <Circle cx={cx} cy={cy} r={r} fill="none" stroke="#E5A63B" strokeWidth={3} opacity={0.9} />
          <Circle cx={cx} cy={cy} r={r - 4} fill="none" stroke="#E5A63B" strokeWidth={0.5} opacity={0.3} />
        </Svg>
      </Animated.View>
      ...
      <View style={[StyleSheet.absoluteFill, { alignItems: 'center', justifyContent: 'center' }]}>
        ...
        <Animated.View style={[{
          ...
          <Svg width={r * 0.85} height={r * 0.55} viewBox="0 0 85 55" style={{ transform: [{ scaleX: -1 }] }}>
            <Path
              d="M85 30 C 70 30, 55 5, 40 12 C 28 18, 15 5, 0 15 C 12 22, 30 38, 50 38 C 65 38, 78 34, 85 30Z"
              fill="#EF4444"
              opacity={0.9}
      ...
      <Animated.View style={[StyleSheet.absoluteFill, caduceusStyle, { alignItems: 'center', justifyContent: 'center' }]}>
        <Svg width={s} height={s} viewBox={`0 0 ${s} ${s}`}>
          {/* Main staff */}
          <Line x1={cx} y1={cy - r * 0.5} x2={cx} y2={cy + r * 0.65} stroke="#2563EB" strokeWidth={3.5} strokeLinecap="round" />
          {/* Head circle */}
      ...
      <Animated.View style={[{
        ...
        <Svg width={r * 0.4} height={r * 0.22} viewBox="0 0 40 22">
          <Ellipse cx={20} cy={11} rx={18} ry={8} fill="none" stroke="#9CA3AF" strokeWidth={2.5} opacity={0.6} />
          <Ellipse cx={20} cy={11} rx={18} ry={8} fill="none" stroke="#D1D5DB" strokeWidth={1} opacity={0.3} />
        </Svg>
      </Animated.View>
    </View>
  );
  ...
  return (
    <View className="flex-1 bg-white">
      ...
      <View className="flex-1" style={{ paddingTop: insets.top }}>
        ...
        <View style={{ flex: phase === 'welcome' ? 0.52 : 1, alignItems: 'center', justifyContent: 'center' }}>
          <AnimatedLogo size={LOGO_SIZE} phase={phase} />

          {/* Brand Name Text */}
          <Animated.View style={[titleStyle, { marginTop: 16 }]} className="items-center">
            <Text style={{ fontSize: 15, fontWeight: '900', letterSpacing: 4, color: '#EF4444', textTransform: 'uppercase' }}>
              Doctors Marriage
            </Text>
            <View className="flex-row items-center mt-1" style={{ gap: 8 }}>
              <View style={{ width: 28, height: 2.5, backgroundColor: '#2563EB', borderRadius: 2 }} />
              <Text style={{ fontSize: 20, fontWeight: '900', letterSpacing: 5, color: '#2563EB', textTransform: 'uppercase' }}>
                Bureau
              </Text>
              <View style={{ width: 28, height: 2.5, backgroundColor: '#2563EB', borderRadius: 2 }} />
            </View>
        ...
        {phase === 'welcome' && (
          ...
          >
            ...
            >
              <AnimatePresence exitBeforeEnter>
                <MotiView
                  ...
                  transition={{ type: 'timing', duration: 500, easing: Easing.bezier(0.2, 1, 0.3, 1) }}
                ...
                >
                  ...
                  <Text className="text-xl font-black text-slate-900 text-center">{FEATURES[currentFeature].title}</Text>
                ...
                {FEATURES.map((_, i) => (
                  <MotiView
                    ...
                    animate={{
                      ...
                      backgroundColor: i === currentFeature ? '#2563EB' : '#e2e8f0',
                    }}
            ...
            <View style={{ gap: 12 }}>
              ...
              >
                <Text className="text-white font-black text-lg mr-2">Get Started</Text>
