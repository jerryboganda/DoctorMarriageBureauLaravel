...
const ReferralPopupModal: React.FC<ReferralPopupModalProps> = ({
    onClose,
    onNavigate,
    popupConfig,
}) => {
            ...
            >
                ...
                <div className="px-6 py-5 flex flex-col gap-5 overflow-y-auto max-h-[60vh]">
                    ...
                    <p className="text-sm text-slate-600 text-center leading-relaxed">
                        {popupConfig.body ||
                            t('referralPopup.defaultBody', {
                                days: popupConfig.bonus_days,
                                count: popupConfig.referrals_needed,
                            })}
                    </p>
                    ...
                    <div className="bg-gradient-to-r from-pink-50 to-rose-50 border border-pink-200 rounded-2xl p-4 text-center">
                        ...
                        <p className="text-xs text-pink-500 mt-1">
                            {t('referralPopup.referralsNeeded', {
                                count: popupConfig.referrals_needed,
                            })}
                        </p>
                    </div>
