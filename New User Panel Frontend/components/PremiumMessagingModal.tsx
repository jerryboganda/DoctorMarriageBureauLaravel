        ...
        <div className="relative border-b border-slate-100 bg-gradient-to-br from-amber-50 via-white to-rose-50 px-5 pt-5 pb-4 sm:px-6">
          ...
          <div className="pr-10">
            ...
            <h3 className="text-xl font-black text-slate-900 sm:text-2xl">
              {step === 'intro' ? t('messages.premiumOnlyTitle') : t('messages.upgradeChoiceTitle')}
            </h3>
            <p className="mt-2 max-w-xl text-sm leading-relaxed text-slate-600">
              {step === 'intro' ? t('messages.premiumOnlyBody') : t('messages.upgradeChoiceBody')}
            </p>
          </div>
        </div>
              ...
              <div className="grid gap-3 sm:grid-cols-3">
                <div className="rounded-2xl border border-amber-200 bg-amber-50 px-4 py-3">
                  <div className="mb-2 flex items-center gap-2 text-amber-700">
                    <Sparkles size={16} />
                    <span className="text-xs font-bold uppercase tracking-wide">{t('messages.premiumBenefit1Label')}</span>
                  </div>
                  <p className="text-sm font-semibold text-slate-900">{t('messages.premiumBenefit1Title')}</p>
                  <p className="mt-1 text-xs leading-relaxed text-slate-600">{t('messages.premiumBenefit1Body')}</p>
                </div>

                <div className="rounded-2xl border border-rose-200 bg-rose-50 px-4 py-3">
                  <div className="mb-2 flex items-center gap-2 text-rose-700">
                    <Gift size={16} />
                    <span className="text-xs font-bold uppercase tracking-wide">{t('messages.premiumBenefit2Label')}</span>
                  </div>
                  <p className="text-sm font-semibold text-slate-900">{t('messages.premiumBenefit2Title')}</p>
                  <p className="mt-1 text-xs leading-relaxed text-slate-600">{t('messages.premiumBenefit2Body')}</p>
                </div>

                <div className="rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3">
                  <div className="mb-2 flex items-center gap-2 text-slate-700">
                    <Wallet size={16} />
                    <span className="text-xs font-bold uppercase tracking-wide">{t('messages.premiumBenefit3Label')}</span>
                  </div>
                  <p className="text-sm font-semibold text-slate-900">{t('messages.premiumBenefit3Title')}</p>
                  <p className="mt-1 text-xs leading-relaxed text-slate-600">{t('messages.premiumBenefit3Body')}</p>
                </div>
              </div>
              ...
              <div className="grid gap-4 md:grid-cols-2">
                ...
                >
                  <div className="flex items-start justify-between gap-4">
                    ...
                    <ArrowRight size={18} className="mt-1 shrink-0 text-rose-400 transition-transform group-hover:translate-x-1" />
                  </div>
                ...
                >
                  <div className="flex items-start justify-between gap-4">
                    ...
                    <ArrowRight size={18} className="mt-1 shrink-0 text-slate-400 transition-transform group-hover:translate-x-1" />
                  </div>
