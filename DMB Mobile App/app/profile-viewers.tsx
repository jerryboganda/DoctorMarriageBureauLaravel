                    ...
                    <View className="pb-28">
                        {filteredViewers.map((viewer, index) => (
                            ...
                            >
                                <TouchableOpacity
                                    onPress={() =>
                                        handleViewProfile(viewer.viewer?.id || viewer.viewer_id)
                                    }
                                ...
                                >
                                    ...
                                    <View className="relative">
                                        {viewer.viewer?.photo ? (
                                            <ProfileImage
                                                path={viewer.viewer.photo}
                                                gender={viewer.viewer.gender}
                                    ...
                                    <View className="flex-1 ml-4">
                                        ...
                                        <View className="flex-row items-center mt-1">
                                            ...
                                            <Text className="text-slate-500 text-xs ml-1">
                                                {viewer.viewer?.city ||
                                                    viewer.viewer?.country ||
                                                    t('profileViewers.locationHidden')}
                                            </Text>
                                        </View>
                                    ...
                                    <View className="flex-col gap-2">
                                        <TouchableOpacity
                                            onPress={() =>
                                                handleSendInterest(
                                                    viewer.viewer?.id || viewer.viewer_id,
                                                    viewer.viewer?.first_name || '',
                                                )
                                            }
                                        ...
                                        <TouchableOpacity
                                            onPress={() =>
                                                router.push(
                                                    `/chat/${viewer.viewer?.id || viewer.viewer_id}`,
                                                )
                                            }
