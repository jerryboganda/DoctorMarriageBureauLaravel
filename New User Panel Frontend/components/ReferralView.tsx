    ...
    const fetchData = useCallback(async () => {
        try {
            ...
            if (statsRes.status === 'rejected') {
                throw new Error(
                    statsRes.reason?.response?.data?.message || 'Failed to load referral data',
                );
            }
        } catch (err: any) {
            ...
            if (res.data.data) {
                setStats((prev) =>
                    prev
                        ? {
                              ...prev,
                              referral_code: res.data.data.code,
                    ...
                    {loading ? (
                        ...
                        <div className="flex items-center justify-center p-20">
                            <div className="flex flex-col items-center gap-3 text-center">
                                ...
                                <button
                                    onClick={fetchData}
                                    className="mt-2 px-4 py-2 bg-primary text-white rounded-full text-sm font-bold hover:bg-primary/90 transition-colors"
                                >
                                    {t('referral.retry')}
                                </button>
                            </div>
                                    ...
                                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 animate-in fade-in slide-in-from-bottom-4">
                                        ...
                                        <div className="space-y-6">
                                                ...
                                                <div className="p-6">
                                                    ...
                                                    <div className="flex items-center justify-between text-sm">
                                                        <span className="text-slate-500">
                                                            {stats.remaining_for_reward > 0
                                                                ? t('referral.remainingForReward', {
                                                                      count: stats.remaining_for_reward,
                                                                  })
                                                    ...
                                                    <div className="grid grid-cols-3 gap-3 mt-4">
                                                        ...
                                                        <div className="rounded-xl bg-amber-50 border border-amber-100 p-3">
                                                            <p className="text-[11px] uppercase tracking-wide text-amber-600 font-bold">
                                                                {t('referral.pendingReview')}
                                                            </p>
                                                        ...
                                                        <div className="rounded-xl bg-purple-50 border border-purple-100 p-3">
                                                            <p className="text-[11px] uppercase tracking-wide text-purple-600 font-bold">
                                                                {t('referral.appliedRewards')}
                                                            </p>
                                            ...
                                            <div className="grid grid-cols-2 gap-4">
                                                ...
                                                <StatCard
                                                    icon={<Check size={18} />}
                                                    label={t('referral.qualifiedCounted')}
                                                ...
                                                <StatCard
                                                    icon={<Award size={18} />}
                                                    label={t('referral.appliedRewards')}
                                                    value={stats.rewards?.length || 0}
                                                    color="purple"
                                                />
                                            </div>
                                                            ...
                                                            >
                                                                ...
                                                                <div className="flex-1 min-w-0">
                                                                    ...
                                                                    <p className="text-xs text-slate-500">
                                                                        {t('referral.referCount', {
                                                                            count: rule.trigger_threshold,
                                                                        })}{' '}
                                                                        →{' '}
                                                                        {formatRewardType(
                                                                            rule.reward_type,
