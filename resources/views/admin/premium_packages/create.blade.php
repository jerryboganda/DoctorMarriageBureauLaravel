            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('packages.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label class="col-md-3 col-form-label" for="express_interest">{{translate('Proposals')}}</label>
                            <div class="col-md-9">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="number" name="profile_viewers_view" id="profile_viewers_view" class="form-control" placeholder="{{translate('Eg. 10')}}" required>
