...
import { ChevronLeftIcon, MailIcon, LockIcon, PhoneIcon, CheckCircleIcon, RefreshCwIcon, KeyIcon } from './Icons';
        ...
        <AnimatePresence mode="wait">
            ...
            >
              <div className="pt-[100px] px-6 pb-10 min-h-full">
                <div className="mb-8">
                  ...
                  <p className="text-slate-500 text-lg leading-relaxed">Enter your email or phone number to receive a recovery code.</p>
                </div>
            ...
            >
              <div className="pt-[100px] px-6 pb-10 min-h-full">
                <div className="mb-8 text-center">
                  ...
                  <p className="text-slate-500 text-sm">Enter the code sent to <span className="font-bold text-slate-900">{contact}</span></p>
                </div>
                ...
                {isLoading && (
                    <p className="text-center text-slate-400 text-xs mt-4 animate-pulse">Verifying code...</p>
                )}
              </div>
            </motion.div>
          )}
              ...
              <div className="pt-[100px] px-6 pb-10 min-h-full">
                ...
                <form onSubmit={handleResetPassword} className="space-y-4">
                  ...
                  <Input 
                      ...
                      onChange={(e: any) => setConfirmPassword((e.target as any).value)}
                  />
                  
                  <div className="pt-4">
                      <Button type="submit" isLoading={isLoading} disabled={!password || !confirmPassword}>
                          Reset Password
                      </Button>
                  </div>
                </form>
          ...
          {step === 3 && (
            ...
            >
              ...
              <Button onClick={onComplete} className="bg-slate-900 text-white shadow-xl shadow-slate-900/20 w-full max-w-xs">
                  Back to Login
              </Button>
            </motion.div>
          )}
