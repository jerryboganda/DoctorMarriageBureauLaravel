            ...
            <div className="grid gap-4 lg:grid-cols-2">
                <div className="rounded-xl bg-white p-4 shadow-sm">
                    ...
                    <div className="space-y-1 text-sm text-slate-600">
                        <div>
                            Total: {stats?.earnings?.currency_symbol || ''}{' '}
                            {stats?.earnings?.total || 0}
                        </div>
                        <div>
                            Last Month: {stats?.earnings?.currency_symbol || ''}{' '}
                            {stats?.earnings?.last_month || 0}
                        </div>
                        <div>
                            Last 6 Months: {stats?.earnings?.currency_symbol || ''}{' '}
                            {stats?.earnings?.last_6_months || 0}
                        </div>
                        <div>
                            Last 12 Months: {stats?.earnings?.currency_symbol || ''}{' '}
                            {stats?.earnings?.last_12_months || 0}
                        </div>
                    </div>
                </div>
