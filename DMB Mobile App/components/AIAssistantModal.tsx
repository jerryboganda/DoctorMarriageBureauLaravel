...
const AIAssistantModal: React.FC<AIAssistantModalProps> = ({
    ...
    const generateBio = () => {
        ...
        setTimeout(() => {
            setGeneratedBio(
                'Passionate medical professional by day, avid mountain explorer by weekend. Seeking a partner to share both quiet coffee moments and summit views.',
            );
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-slate-500">
                                        Your personal marriage assistant
                                    </p>
                                </div>
                            </div>
                            <button
                                    ...
                                    >
                                        ...
                                        {generatedBio && (
                                            <motion.div
                                                ...
                                                className="p-4 bg-indigo-50 rounded-2xl border border-indigo-100 relative"
                                            >
                                                <div className="absolute -top-3 left-4 bg-indigo-600 text-white text-[10px] font-bold px-2 py-0.5 rounded-full uppercase">
                                                    Polished
                                                </div>
                                                <p className="text-indigo-900 text-sm italic leading-relaxed">
                                                    "{generatedBio}"
                                                </p>
                                                <button className="mt-3 w-full py-2 bg-white text-indigo-600 rounded-lg text-xs font-bold border border-indigo-200 hover:bg-indigo-50">
                                                    Apply to Profile
                                                </button>
                                            </motion.div>
                                        )}
                                    ...
                                    >
                                        <div className="p-4 bg-amber-50 rounded-2xl border border-amber-100 mb-6 flex items-start gap-3">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-xs text-amber-700 leading-relaxed mt-1">
                                                    Based on the profile, interest in{' '}
                                                    <strong>Hiking</strong> and{' '}
                                                    <strong>Neurology</strong> is aligned.
                                                </p>
                                            </div>
                                        </div>

                                        <label className="text-xs font-bold text-slate-400 uppercase tracking-widest mb-3 block">
                                            Suggested Respectful Openers
                                        </label>
                                        <div className="space-y-3">
                                            {[
                                                ...
                                                <button
                                                    key={i}
                                                    className="w-full text-left p-4 bg-white border border-slate-100 rounded-2xl shadow-sm hover:border-indigo-200 hover:bg-indigo-50 transition-all group"
                                                >
                                                    <p className="text-slate-700 text-sm group-hover:text-indigo-900">
                                                        {text}
                                                    </p>
                                                </button>
                                            ))}
                                    ...
                                    >
                                        ...
                                        <div className="space-y-3">
                                            <div className="flex items-center gap-3 p-3 bg-green-50 rounded-xl border border-green-100">
                                                <div className="w-5 h-5 bg-green-200 rounded-full flex items-center justify-center text-green-700">
                                            ...
                                            <div className="flex items-center gap-3 p-3 bg-white rounded-xl border border-slate-100">
                                                ...
                                                <span className="text-sm font-medium text-slate-500">
                                                    Add 2 more profile photos
                                                </span>
                                            </div>
                                            <div className="flex items-center gap-3 p-3 bg-white rounded-xl border border-slate-100">
                                                <div className="w-5 h-5 bg-slate-100 rounded-full border-2 border-slate-300" />
                                                <span className="text-sm font-medium text-slate-500">
                                                    Complete 'Family Values' section
                                                </span>
                                            </div>
                                        </div>
                                    </motion.div>
