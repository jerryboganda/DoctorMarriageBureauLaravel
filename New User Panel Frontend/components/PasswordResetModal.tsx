...
import { X, Loader2, ChevronLeft, Mail } from 'lucide-react';
        ...
        >
            ...
            >
                ...
                <div className="p-5 space-y-4">
                    {success && (
                        <div className="rounded-xl bg-emerald-50 text-emerald-700 text-sm px-3 py-2">
                            {success}
                        </div>
                    )}
                    {error && (
                    ...
                    {step === 'code' && (
                        <div className="space-y-4">
                            ...
                            <button
                                ...
                                className="w-full py-2 text-sm font-bold text-slate-500 hover:text-slate-800 flex items-center justify-center gap-2"
                            >
                    ...
                    {step === 'new-password' && (
                        <div className="space-y-4">
                            ...
                            <div>
                                <label className="block text-xs font-bold text-slate-700 uppercase mb-1">
                                    {t('auth.welcome.confirmPassword')}
                                </label>
                                <input
                                    type="password"
