            ...
            <div class="card-body">
                <form action="{{ route('countries.store') }}" method="POST" >
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" id="name" name="name" value="{{ old('name') }}" placeholder="{{ translate('Country Name') }}" class="form-control" required>
                         @error('name')
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" id="code" name="code" value="{{ old('code') }}" placeholder="{{ translate('Country Code (e.g., US, UK, PK)') }}" class="form-control" required>
                         @error('code')
                             <small class="form-text text-danger">{{ $message }}</small>
                         @enderror
                    </div>
