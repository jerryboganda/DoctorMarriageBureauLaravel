...
export default function SettingsScreen({ onBack, section = 'account' }: SettingsScreenProps) {
    ...
    const renderHeader = () => (
        <View className="px-5 pt-12 pb-4 bg-white border-b border-slate-100 flex-row items-center gap-3">
            <TouchableOpacity
                onPress={onBack}
                className="w-10 h-10 items-center justify-center -ml-2 bg-slate-50 rounded-full"
            >
    ...
    const renderAccount = () => (
        <View className="p-5">
            ...
            <Text className="text-xs font-bold text-slate-400 uppercase tracking-widest mb-4 mt-8">
                App Settings
            </Text>
            <SettingsItem
                icon={BellIcon}
            ...
            />
            <SettingsItem icon={FileTextIcon} label="Terms of Service" onPress={() => {}} />
            ...
            <Text className="text-center text-slate-300 text-xs font-bold mt-6">
            ...
            <View className="bg-blue-50 p-4 rounded-2xl mb-8 border border-blue-100">
                <View className="flex-row gap-3">
                    ...
                    <View className="flex-1">
                        <Text className="font-bold text-blue-800 text-lg mb-1">
                            Secure Mode Active
                        </Text>
                        <Text className="text-blue-600 text-xs leading-5">
                            Your profile is currently visible only to verified doctors.
                        </Text>
                    </View>
                </View>
            </View>
