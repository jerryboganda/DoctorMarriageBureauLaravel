...
@section('content')
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('settings.update') }}" method="POST">
                        ...
                        <div class="form-group row">
                            <label class="col-sm-3 col-from-label">{{ translate('Member Profile Picture Privacy') }}
                                <br>
                                <i>
                                    <code>({{ translate('Who Can See') }})</code>
                                </i>
                            </label>
                            <div class="col-sm-9">
                        ...
                        <div class="form-group row">
                            <label class="col-sm-3 col-from-label">{{ translate('Member Gallery Image Privacy') }}
                                <br>
                                  <i>
                                    <code>({{ translate('Who Can See') }})</code>
                                </i>
    ...
    echo 'checked';
                    ...
                    <div class="form-group row">
                        <label
                            class="col-sm-8 col-from-label">{{ translate('Member Verification') }}</label>
                        <div class="col-sm-4">
                            <label class="aiz-switch aiz-switch-success mb-0">
                                <input type="checkbox" onchange="updateSettings(this, 'member_verification')"
                                    <?php if (get_setting('member_verification') == 1) {
                                        echo 'checked';
                                    } ?>>
                                <span class="slider round"></span>
                            </label>
                    ...
                    <div class="form-group row">
                        <div class="col-sm-8">
                            <label class="col-from-label">{{ translate('Member Profile Picture Approval by Admin.') }}
                                <i>
                                    <code>({{ translate('If you disable this, all registered members will be able to upload profile picture wihtout verification.') }})</code>
                                </i>
                            </label>
                        </div>
                        <div class="col-sm-4">
                    ...
                    <div class="form-group row">
                        <label
                            class="col-sm-8 col-from-label">{{ translate('Disable image encoding?') }}</label>
                        <div class="col-sm-4">
                            <label class="aiz-switch aiz-switch-success mb-0">
