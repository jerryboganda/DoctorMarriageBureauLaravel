...
const DevicesScreen = () => {
    ...
    const handleRevokeDevice = async (device: Device) => {
        if (device.is_current) {
            Alert.alert(t('devices.signOut'), t('devices.signOutCurrentMsg'), [
    ...
    const handleRevokeAll = () => {
        Alert.alert(t('devices.signOutAll'), t('devices.signOutAllMsg'), [
            { text: t('common.cancel'), style: 'cancel' },
            {
    ...
    return (
        <View className="flex-1 bg-slate-50">
            ...
            >
                ...
                >
                    <Text className="text-blue-800 text-sm">🔒 {t('devices.securityNote')}</Text>
                </MotiView>
                        ...
                        <View className="flex-row items-start">
                            ...
                            >
                                {revoking === device.id ? (
                                    ...
                                    <TrashIcon
                                        size={18}
                                        color={device.is_current ? '#64748b' : '#ef4444'}
                                    />
                                )}
                            </TouchableOpacity>
                        </View>
