            ...
            <div className="bg-white w-full max-w-md rounded-2xl shadow-2xl overflow-hidden animate-in zoom-in-95 duration-200">
                ...
                <div className="p-6">
                    <div className="bg-blue-50 border border-blue-100 rounded-lg p-3 flex gap-2 mb-6">
                        ...
                        <p className="text-xs text-blue-800">{t('modals.decline.description')}</p>
                    </div>
                    {error && <div className="mb-4 text-xs font-bold text-red-600">{error}</div>}

                    <h3 className="text-sm font-bold text-slate-900 mb-3">
                        {t('modals.decline.selectReason')}{' '}
                    ...
                    <div className="mt-6 p-4 bg-slate-50 rounded-xl border border-slate-100">
                        <h4 className="text-xs font-bold text-slate-400 uppercase tracking-wide mb-1">
                            {t('modals.decline.messagePreview')}
                        </h4>
