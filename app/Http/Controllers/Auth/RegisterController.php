    ...
    */
    ...
    protected function validator(array $data)
    {
        if (isset($data['phone'])) {
            ...
            if (str_starts_with($data['phone'], '03') && Str::length($data['phone']) === 11) {
                $data['phone'] = '+92'.Str::substr($data['phone'], 1);
            } elseif (str_starts_with($data['phone'], '3') && Str::length($data['phone']) === 10) {
