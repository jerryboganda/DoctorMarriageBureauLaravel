...
import type { IncomingInterest } from '../../types';
import {
    HeartIcon,
    MapPinIcon,
    CheckIcon,
            ...
            const mapped: IncomingInterest[] = rows.map((item: any) => {
                ...
                return {
                    ...
                    profile: {
                        ...
                        hospital: item.mothere_tongue
                            ? `Mother Tongue: ${item.mothere_tongue}`
                            : '',
                            ...
                            <View className="flex-row items-center gap-4 mt-3 flex-wrap">
                                <View className="flex-row items-center gap-1.5 bg-slate-50 px-3 py-1.5 rounded-full">
                                    ...
                                    <Text className="text-slate-600 text-xs font-medium">
                                        {profile.location || t('proposals.locationNA')}
                                    </Text>
                                </View>
                                <View className="flex-row items-center gap-1.5 bg-slate-50 px-3 py-1.5 rounded-full">
                                    ...
                                    <Text className="text-slate-600 text-xs font-medium">
                                        {profile.age
                                            ? t('proposals.years', { age: profile.age })
                                            : t('proposals.ageNA')}
                                    </Text>
                                </View>
                            </View>
            ...
            >
                <View className="px-6 py-5 flex-row justify-between items-start">
                    <MotiView
                        ...
                        animate={{ opacity: 1, translateY: 0 }}
                    >
                        <Text className="text-sm text-blue-200 font-medium">
                            {t('proposals.welcomeBack')}
                        </Text>
                ...
                <View className="flex-row items-center gap-3">
                    ...
                    <View>
                        <Text className="font-bold text-slate-900">
                            {t('proposals.completeProfile')}
                        </Text>
                        <Text className="text-xs text-slate-500">
                            {t('proposals.getBetterMatches')}
                        </Text>
                    </View>
                </View>
